 ...
 *
 * Source: https://medium.com/android-news/viewbinding-in-fragments-the-clean-easy-way-2f0ce68aee22
 */
private const val TAG = "ViewBindingHolder"
...
class ViewBindingHolderImpl<T : ViewBinding> : ViewBindingHolder<T>, LifecycleObserver {
    ...
    private val lifeCycleEventObserver = LifecycleEventObserver { owner, event ->
        Log.d(TAG, "LifecycleEventObserver: $owner at $event")
